...
export function LandingPage() {
  ...
  return (
    <main className="w-full overflow-x-hidden bg-white text-foreground">
      {/* Hero — nav on white; headline + mockup inside rounded gradient frame */}
      <section className="bg-white px-4 pb-8 pt-4 sm:px-6 sm:pb-10 sm:pt-5">
        ...
        <div
          className={cn(
            landing.page,
            "relative mt-3 overflow-hidden border border-black/[0.08] bg-[radial-gradient(ellipse_120%_90%_at_50%_0%,#b8e4f4_0%,#dff3fa_42%,#f5fbfe_78%,#ffffff_100%)] px-4 pb-16 pt-10 sm:mt-4 sm:px-8 sm:pb-20 sm:pt-14",
            landing.heroFrame,
          )}
        >
